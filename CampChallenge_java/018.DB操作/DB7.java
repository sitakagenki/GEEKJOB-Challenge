    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //フォームで更新する値を受け取る    
          ...
          try{
            ...
            dbps = dbcon.prepareStatement("update profiles set name = ? , tel = ? , age = ? , birthday = ? where profilesID = ?");
            dbps.setString(1,nametrim);
            dbps.setString(2,teltrim);
            dbps.setInt(3,ageint);
            dbps.setString(4,birthdaytrim);
            dbps.setInt(5,IDint);
